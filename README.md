...
| <nobr>`create-design-doc`</nobr> | Creates design documents through interactive discovery. Use when the user says "create a design doc", "write a design doc", "create a TDD", "write a TDD", "create a design doc for X", "technical spec", "architecture document", or "design proposal". Do NOT use for PRD, RFC, or ADR docs. |
